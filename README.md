A Soccer Player & Quote Reader web app was built in this project. The Ionic mobile application was used to write the app that reads soccer player data, flag data, and quotes from internet resources.
